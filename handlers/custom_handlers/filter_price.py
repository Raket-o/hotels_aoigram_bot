""" Модуль фильтра по ценовому диапазону"""
import loader
import logging
import sqlite3
...
logger = logging.getLogger("logger_handler_filter_price")


@dp.message_handler(state=UserInfoState.set_price)
async def get_filter_price(message: types.Message, state: FSMContext) -> None:
    """
    Функция get_filter_price. Проверят правильно ли выбрана категория фильтра.
